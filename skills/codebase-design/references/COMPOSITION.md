...
The honest failure mode of this file: closure is seductive, and a combinator library built for three call sites is over-engineering with better literature behind it. The evidence rule in [SKILL.md](../SKILL.md#stance) still applies.
