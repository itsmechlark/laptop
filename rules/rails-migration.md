...
- Push integrity to the database (NOT NULL, foreign-key and unique constraints, indexes on foreign keys and lookup columns), give every foreign key an explicit `on_delete` behavior, and set default values here rather than in the model.
